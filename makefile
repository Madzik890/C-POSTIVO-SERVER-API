CC = gcc
SOURCE = ./src/postivoS.c ./src/postivoService.c ./src/data/clientsData.c ./src/serverLogs.c ./src/serverOptions.c ./src/server.c ./src/documentFile.c ./src/shipments.c ./src/senders.c
